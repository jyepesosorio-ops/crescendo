...
const heroFooter = document.querySelector('.hero-footer.reveal');
...
document.querySelectorAll('.demo-tab').forEach((tab) => {
  tab.addEventListener('click', () => {
    ...
    gsap.fromTo(panel, { opacity: 0 }, { opacity: 1, duration: reducedMotion ? 0 : 0.25 });
  });
});
